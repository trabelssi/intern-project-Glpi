...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
            ...
            // Recent activity with validation
            $recentActivity = $this->getRecentActivity($user);

            // Project statistics with validation
            $projectStats = $this->getProjectStatistics($dateRange);

            // User statistics with validation
            $userStats = $this->getUserStatistics($dateRange);

            // Tasks per project with validation
            $tasksPerProject = $this->getTasksPerProject();

            // Interventions per project with validation
