    ...
    <div className="text-center p-6 rounded-lg bg-gray-800/50 border border-gray-700/30">
      ...
      <p className="text-sm text-gray-500">
        {searchTerm 
          ...
          : "Ajoutez des tâches pour voir les statistiques"}
      </p>
    </div>
  </div>
);
  ...
  <div className="mt-8 pt-8 border-t border-gray-700/50">
    <div className="flex items-center gap-2 mb-6">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400">Sélectionnez un projet pour voir la répartition des tâches par produit</p>
      </div>
    </div>
    ...
    <div className="bg-gray-800/50 rounded-lg border border-gray-700/30 p-8">
      <div className="flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-medium text-gray-300 mb-2">Aucun projet sélectionné</h3>
        <p className="text-gray-500 max-w-sm">
          Pour voir la distribution des tâches par produit, veuillez sélectionner un projet spécifique dans les filtres ci-dessus.
        </p>
  ...
  return (
    <div className="mt-8 pt-8 border-t border-gray-700/50">
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
          <h4 className="text-lg font-semibold text-white">Distribution par Produit</h4>
          <p className="text-sm text-gray-400">Répartition des tâches par produit et statut</p>
        </div>
      </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">
                Tâches par Statut pour « {projectFilter} »
    ...
    <div className="bg-gradient-to-br from-gray-800/30 via-gray-900/20 to-gray-800/30 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50 shadow-lg hover:shadow-cyan-500/5 transition-all duration-300 h-full">
      ...
      <div className="mb-6">
        ...
        {searchTerm && <span className="text-sm text-gray-400 ml-2">(Filtré: "{searchTerm}")</span>}
              ...
              <p className="text-sm text-gray-400">
                Vue d'ensemble des tâches par machine
                {timeRange !== 'all' && (
                  <span className="text-blue-400 ml-2">• {getTimeRangeLabel(timeRange)}</span>
                )}
              </p>
            ...
            {filteredProjectData.map((entry, index) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="text-xs text-gray-500">{entry.tasks} tâches</div>
                </div>
